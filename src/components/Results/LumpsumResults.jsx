import { calculateLumpsumInvestmentResults, formatter } from "../../util/investment";

export default function LumpsumResult({ input }) {
    const results = calculateLumpsumInvestmentResults(input);
    return (
        <table id="result">
            <thead>
                <tr>
